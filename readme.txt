=== Fasty Delivery for WooCommerce ===
Tags: ecommerce, shipping, delivery, Fasty delivery
Tested up to: 5.7.2
Requires PHP: 5.4
...
This is a Fasty Delivery plugin for WooCommerce.

This plugin allows you to create Fasty deliveries for your WooCommerce orders. To get an API key, visit [business.Fasty.ng](https://business.Fasty.ng) and signup for a Fasty Developer account.

= Note =

Fasty currently serves only __Lagos, Nigeria__.
...
6.  Add a new Shipping Zone, with the `Zone Region` set as __Lagos__. Click on `Add Shipping Method` and select __Fasty Delviery__ from the list of options.
7.  Configure your __Fasty Delivery__ settings. See below for details.



= Configure the plugin =
To configure the plugin, go to __WooCommerce > Settings__ from the left hand menu, then click __Shipping__ from the top tab. You will see __Fasty__ as part of the available Shipping Options. Click on it to configure the shipping method.

* __Enable/Disable__ - check the box to enable the Fasty Delivery shipping method.
...
* __Schedule Shipping Task__ - Choose when Fasty orders are created.
* __Additional Handling Fee__ - Add an additional handling fee to the delivery total.
* __Pickup Delay Time__ - Enter a delay for auto-created Fasty deliveries.
* __Pickup Schedule Time__ - Enter a daily time for scheduled Fasty deliveries.
...
To manually create Fasty Delivery orders if you have selected this option, go to the Woocommerce Orders page on **WooCommerce > Orders** and click on the order to the Detail page. On the top-right side of the page, select "Create Fasty Delivery order" from **Order Actions** and click the **>** button next to it.
...
Visit [Fasty.ng/faq](https://www.Fasty.ng/faq).

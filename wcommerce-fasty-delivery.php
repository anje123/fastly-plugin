...
define('WC_Fasty_DELIVERY_MAIN_FILE', __FILE__);

/**
 * WCommerce Fasty Delivery Loader.
 */
class WC_Fasty_Delivery_Loader {
    /** 
     ...
     */
    const PLUGIN_NAME = 'Fasty Delivery for WooCommerce';

    /** 
     * The plugin slug, for action links.
     */
    const PLUGIN_SLUG = 'Fasty-delivery-for-woocommerce';

    /**
     * Single instance of this class.
     *
     * @var \WC_FastyDelivery_Loader
     */
    ...
    public function init_plugin() {
        ...
        require_once(plugin_dir_path(__FILE__) . 'delivery-platform-api.php');
    ...
    {
        $links[] = '<a href="' . admin_url('admin.php?page=wc-settings&tab=shipping&section=Fasty_delivery') . '">' . __('Settings') . '</a>';
        return $links;
    }
     ...
     *
     * @see \WC_FastyDelivery_Loader_Loader::add_admin_notice()
     *
     */
...
WC_Fasty_Delivery_Loader::instance();

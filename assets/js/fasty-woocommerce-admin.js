(function($) {
                ...
                data.data.forEach(result => {
                    if (result.lat && result.lng) {
                        ...
                        $div.on('click', function() {
                            ...
                            $("#woocommerce_Fasty_delivery_pickup_base_address").val(address);
                            _this.val(address);
    ...
    $(document).ready(function() {
        $('#woocommerce_Fasty_delivery_pickup_state').attr('readonly', true).val("Lagos");
        $('#woocommerce_Fasty_delivery_pickup_base_address').attr('autocomplete', 'off')
            .after(`
        ...
        if($('#woocommerce_Fasty_delivery_pickup_base_address').val() != '') {
            $('#pickup_address').val($('#woocommerce_Fasty_delivery_pickup_base_address').val());
        }
    });
})(jQuery);